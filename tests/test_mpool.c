...
static void test_mpool_basics(void) {
  size_t pages;
  SAC_MPool mpool;
...
static void test_mpool_freepage(void) {
  size_t pages;
  SAC_MPool mpool;
...
static void test_mpool_realloc(void) {
  SAC_MPool mpool;
  void *p1, *p2, *p3, *p4, *p5;
...
static void test_mpool_strdup(void) {
  SAC_MPool mpool;
  char *s;
...
static void test_mpool_strndup(void) {
  SAC_MPool mpool;
  char *s;
  mpool = SAC_mpool_open(256);
